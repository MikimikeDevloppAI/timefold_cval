...
public class ShiftSlot {
    ...
    private boolean fullDaySlot = false;  // True if this is a combined AM+PM slot for closing locations
    ...
    // Closing role is delegated from shift.getClosingRoleEnum()
    ...
    /**
     * Get the closing role for this slot (1R, 2F, 3F or null).
     * Delegates to the parent Shift's closingRoleEnum.
     */
    public ClosingRole getClosingRole() {
        return shift != null ? shift.getClosingRoleEnum() : null;
    }

    /**
     * Check if this slot carries a closing responsibility.
     */
    public boolean hasClosingRole() {
        return getClosingRole() != null;
    }

    /**
     * Check if this is a closing shift.
     */
    ...
    /**
     * Get the designated staff for this slot (for admin 1:1 model).
     */
    public Staff getDesignatedStaff() {
        return shift != null ? shift.getDesignatedStaff() : null;
    }

    public boolean isFullDay() {
        return fullDaySlot || getPeriodId() == 0;
    }

    public boolean isFullDaySlot() {
        return fullDaySlot;
    }

    public void setFullDaySlot(boolean fullDaySlot) {
        this.fullDaySlot = fullDaySlot;
    }
