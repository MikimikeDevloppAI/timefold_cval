...
public class Shift {
    ...
    private String needType;    // 'consultation', 'surgical', 'admin', 'closing'
    private boolean isAdmin;
    private ClosingRole closingRoleEnum; // ROLE_1R, ROLE_2F, ROLE_3F or null
    ...
    // For admin shifts: the specific staff this slot is designated for (1:1 model)
    private Staff designatedStaff;
    ...
    public ClosingRole getClosingRoleEnum() { return closingRoleEnum; }
    public void setClosingRoleEnum(ClosingRole closingRoleEnum) { this.closingRoleEnum = closingRoleEnum; }

    // Backward compatibility: String getter (returns display name or null)
    public String getClosingRole() {
        return closingRoleEnum != null ? closingRoleEnum.getDisplayName() : null;
    }
    ...
    public Staff getDesignatedStaff() { return designatedStaff; }
    public void setDesignatedStaff(Staff designatedStaff) { this.designatedStaff = designatedStaff; }
    ...
    public String toString() {
        ...
        String closing = closingRoleEnum != null ? "/" + closingRoleEnum.getDisplayName() : "";
